...
export const TourHelper = ({ doEnableTours, className = '', size = 23, t }) => {
  ...
  return (
    <button className={`dib pointer ${className}`} onClick={handleClick} aria-label={ t('startTourHelper')} style={{ background: 'none', border: 'none', padding: 0, display: 'flex', alignItems: 'center' }}>
